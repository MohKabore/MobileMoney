...
namespace MobileMoney.API.Models {
    public class User : IdentityUser<int> {
        ...
        // public District District { get; set; }      // public int? ClassId { get; set; }
        // public Class Class { get; set; } // public int? CityId { get; set; }
        // public City City { get; set; }  // public int UserTypeId { get; set; }
        // public UserType UserType { get; set; }  // public DateTime? ResetPasswordDate { get; set; }
